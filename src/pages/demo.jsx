...
">
    ...
    ">
        ...
        <section className="bg-transparent pb-12 lg:pb-2 w-full relative pt-8 sm:pt-2">
          ...
          <div className="absolute sm:top-[85%] left-[90%] w-[300px] h-[100px] md:w-[300px] md:h-[300px] bg-gradient-to-r bg-radial-market rounded-full filter blur-[90px] opacity-60 -translate-x-1/2 -translate-y-1/2 z-[-10]  "></div>
