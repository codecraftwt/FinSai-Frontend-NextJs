...
export default function ClientHomePage({ data = {}, scrollToSection }) {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  useEffect(() => {
    ...
    if (isSmallScreen) {
      ...
      const animateCycle = async () => {
        ...
        // Ensure controls are available before starting animations
        try {
          await Promise.all([
      ...
      // Use requestAnimationFrame to ensure component has mounted
